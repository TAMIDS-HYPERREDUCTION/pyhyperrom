...
\begin{document}
	...
	\title{Linear Heat Conduction Problem}
	\author{}
	\date{}
	\maketitle
	...
	We consider a \textbf{linear heat conduction problem} defined over a 1D domain with spatial coordinate \( x \), where the system consists of different material properties and external heat sources.
	
	\paragraph{Governing Equation}
	The heat conduction is governed by the linear steady-state heat equation:
