...
class HeatConductionSimulationData:
    ...
    def __init__(self, n_ref, L, quad_deg=3, num_snapshots=15, pb_dim=1, params = np.arange(1., 4.0, 0.01), T_init_guess = 273.0, train_mask=None, test_mask=None):
...
class ROM_simulation:
    ...
    def run_simulation_h_deim(self):
        ...
        for i in range(len(self.param_list_test[:self.N_rom_snap])):
            ...
            T_init_rom = np.transpose(self.V_sel) @ sol_fos_[i]
